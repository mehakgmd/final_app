...
const Jewellery = () => {
  return (
    <div className="px-1 text-black-700" >
        {/* top */}
    ...
    <p className="text-lg leading-5">Lorem ipsum dolor sit amt, consectetur adipiscing elit.</p>
            ...
            <div className="flex flex-col lg:flex-row basis-1/2">
                <div className="w-full px-4 lg:px-0 lg:w-80">
                    <Image width={1000} height={1000} src={feature} alt={'feature'}></Image>
                </div>
                <div className='space-y-6 md:sapce-y-3 p-6'>
                    <p style={{wordSpacing: "0.8rem"}} className="h-[80%] lg:max-w-[15rem]">
