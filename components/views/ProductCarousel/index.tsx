    ...
    return (
        <div className="space-y-4">
            <div className="text-center space-y-3">
                ...
                <h3 className="text-3xl text-black-800 font-bold">Check What We Have</h3>
            </div>
            <div
                onMouseMove={mouseMoves}
                onMouseDown={mouseDown}
                onMouseUp={mouseUp}
                className="select-none flex gap-4 overflow-x-hidden scrollGrab py-4 px-5 overflow-y-hidden"
