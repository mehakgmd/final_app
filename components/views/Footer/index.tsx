...
const Footer = () => {
    return (
        <footer className="text-black-500 body-font">
                ...
                <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-start">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10 space-y-4">
                            <li>
                                <a className="text-black-600 hover:text-gray-800">About</a>
                            </li>
                            <li>
                                <a className="text-black-600 hover:text-gray-800">Terms of Use</a>
                            </li>
                            <li>
                                <a className="text-black-600 hover:text-gray-800">Privacy Policy</a>
                            </li>
                            <li>
                                <a className="text-black-600 hover:text-gray-800">How it Works</a>
                            </li>
                            <li>
                                <a className="text-black-600 hover:text-gray-800">Contact Us</a>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10 space-y-4">
                            <li>
                                <a className="text-black-600 hover:text-gray-800">Support Carrer</a>
                            </li>
                            <li>
                                <a className="text-black-600 hover:text-gray-800">24h Service</a>
                            </li>
                            <li>
                                <a className="text-black-600 hover:text-gray-800">Quick Chat</a>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10 space-y-4">
                            <li>
                                <a className="text-black-600 hover:text-gray-800">Whatsapp</a>
                            </li>
                            <li>
                                <a className="text-black-600 hover:text-gray-800">Support 24h</a>
                            </li>
                        </nav>
                    </div>
                </div>
            ...
            <div className="bg-gray-100">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-black-500 text-sm text-center sm:text-left">© 2023 Mehak Mohe-ud-Din —
                        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-black-600 ml-1" target="_blank">@Mehak Mohe-ud-Din</a>
                    </p>
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                        ...
                        <Link href={"https://github.com/mehakgmd"} className="w-5 h-5 ml-3 text-gray-500">
